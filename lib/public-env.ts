...
export const publicEnv = isBuild 
  ? {
      NEXT_PUBLIC_SUPABASE_URL: envValues.NEXT_PUBLIC_SUPABASE_URL || "https://placeholder.supabase.co",
      NEXT_PUBLIC_SUPABASE_ANON_KEY: envValues.NEXT_PUBLIC_SUPABASE_ANON_KEY || "placeholder",
      NEXT_PUBLIC_STARKNET_RPC_URL: envValues.NEXT_PUBLIC_STARKNET_RPC_URL || "https://placeholder.rpc",
      NEXT_PUBLIC_STARKNET_NETWORK: envValues.NEXT_PUBLIC_STARKNET_NETWORK || "sepolia",
      NEXT_PUBLIC_STARKNET_STAKING_CONTRACT: envValues.NEXT_PUBLIC_STARKNET_STAKING_CONTRACT || "0x0",
      NEXT_PUBLIC_STARKNET_NFT_CONTRACT: envValues.NEXT_PUBLIC_STARKNET_NFT_CONTRACT || "0x0",
    } as z.infer<typeof PublicEnvSchema>
  : PublicEnvSchema.parse(envValues);
